...
$statement = $db->prepare('
    SELECT items.id, items.name, items.description, items.price, 
           ...
           sizes.name AS size, colors.name AS color, states.name AS state, items.image
    FROM items 
        ...
        <div class="row">
            <div class="col-sm-6">
                ...
                <form>
                    ...
                    <div class="form-group">
                        <label>Etat:</label><?php echo '  '.$item['state'];?>
                    </div>
                    <div class="form-group">
                        <label>Couleur:</label><?php echo '  '.$item['color'];?>
                    </div>
                    <div class="form-group">
                        <label>Taille:</label><?php echo '  '.$item['size'];?>
                    </div>
                    <div class="form-group">
                        <label>Marque:</label><?php echo '  '.$item['brand'];?>
                    </div>
                    <div class="form-group">
